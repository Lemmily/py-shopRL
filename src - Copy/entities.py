...
class Trader:
    ...
    def rejected_offer(self, commodity, price, quantity, ):
        ...
        self.resources[commodity][
            1] += quantity  # TODO: here would just be pushing the resource object back into the array.
...
class AI_Hero(Basic_AI):
    ...
    def assess_motives(self):
        ...
        for key in self.dict_motive.keys():
            if self.dict_motive[key] > highest:
                highest = key
